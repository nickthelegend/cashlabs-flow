...
const nodeData = [
  ...
  { id: "selectUTXOs", label: "SELECT UTXOs", icon: CheckCircle, color: "text-slate-300" },
  { id: "splitUTXO", label: "SPLIT UTXO", icon: Scissors, color: "text-pink-400" },
  { id: "mergeUTXOs", label: "MERGE UTXOs", icon: Merge, color: "text-sky-400" },
  ...
  { id: "batchPayments", label: "BATCH PAY", icon: Layers, color: "text-teal-400" },
  { id: "shuffleOutputs", label: "SHUFFLE", icon: Shuffle, color: "text-purple-400" },
  { id: "equalizeAmounts", label: "EQUALIZE", icon: EqualNot, color: "text-indigo-400" },
  { id: "mixPoolJoin", label: "MIX POOL", icon: RefreshCcw, color: "text-cyan-400" },
  { id: "autoRemix", label: "AUTO REMIX", icon: Infinity, color: "text-emerald-400" },
  ...
  { id: "feeController", label: "FEE CONTROL", icon: Settings2, color: "text-amber-400" },
  { id: "customChange", label: "CHANGE OUT", icon: ArrowRight, color: "text-slate-400" },
  { id: "loop", label: "LOOP", icon: RefreshCcw, color: "text-indigo-400" },
  { id: "mathNode", label: "MATH", icon: Calculator, color: "text-pink-400" },
  { id: "variableNode", label: "VARIABLE", icon: Database, color: "text-slate-400" },
  { id: "condition", label: "CONDITION", icon: GitBranch, color: "text-teal-400" },
...
const nodeTypes: NodeTypes = {
  ...
  selectUTXOs: UTXOSelectionNode,
  splitUTXO: SplitUTXONode,
  mergeUTXOs: MergeUTXONode,
  batchPayments: BatchPaymentNode,
  customChange: CustomChangeNode,
  feeController: FeeNode,
  shuffleOutputs: ShuffleNode,
  equalizeAmounts: EqualizeNode,
  mixPoolJoin: MixPoolNode,
  autoRemix: AutoRemixNode,
  loop: LoopNode,
  mathNode: MathNode,
...
function getDefaultConfig(nodeType: string) {
  const configs: Record<string, any> = {
    account: { wif: null, address: null, mnemonic: null },
    prepareWallet: {},
    ...
    generateWallet: {},
    selectUTXOs: { count: 5 },
    splitUTXO: { count: 10, amountPerOutput: 0.0001 },
    mergeUTXOs: {},
    batchPayments: { recipients: "" },
    customChange: { address: null },
    feeController: { rate: 1 },
    shuffleOutputs: {},
    equalizeAmounts: { target: 0.001 },
    mixPoolJoin: { pool: "Global" },
    autoRemix: { target: 5 },
    loop: { iterations: 3 },
    mathNode: { operation: "sum", value: 1 },
    variableNode: { key: "VAR_1", value: "" },
  }
